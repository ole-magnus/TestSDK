...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/olemaga/TestSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'olemaga' => 'ole.magnus.aker@schibsted.com' }
  s.source           = { :git => 'https://github.com/olemaga/TestSDK.git', :tag => s.version.to_s }
